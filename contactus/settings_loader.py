...
try:
	...
	raise ValidationError({"detail": "please add email backend in projects settings.py", 
								"data": ["EMAIL_USE_TLS", "EMAIL_HOST", "EMAIL_PORT", "EMAIL_HOST_USER", "EMAIL_HOST_PASSWORD"]})
